...
class MovieServices {
  ...
  static Future<DetailMovie> getDetailMovie(Movie movie,
      {int movieID, http.Client client}) async {
    String url =
        "http://api.themoviedb.org/3/movie/${movieID ?? movie.id}?api_key=$apiKey&language=en-US";
    ...
    return movieID != null
        ? DetailMovie(Movie.fromJson(data),
            language: language,
            genres: genres
  ...
  static Future<List<CreditMovie>> getCredits(int movieID,
