                      ...
                      Column(
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            color:
                                !isExpired ? accentColor2 : Colors.transparent,
                          )
                        ],
                      ),
                      Column(
    ...
    return ListView.builder(
        ...
        itemBuilder: (_, index) => GestureDetector(
              onTap: () {
                context
                    .bloc<PageBloc>()
                    .add(GoesToTicketDetailPage(sortedTickets[index]));
              },
              child: Container(
                  ...
                  children: <Widget>[
                      ...
                      decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                              image: NetworkImage(imageBaseURL +
                                  'w500' +
                                  sortedTickets[index].detailMovie.posterPath),
                              fit: BoxFit.cover)),
                    ),
                    SizedBox(
                      width: 16,
                    ...
                    SizedBox(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Text(
                              sortedTickets[index].detailMovie.title,
